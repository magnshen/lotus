...
// sets up information about the premined actors in the genesis state
...
func (sm *StateManager) setupGenesisActorsTestnet(ctx context.Context) error {
	...
	// 6 months
	totalsByEpoch[183*builtin.EpochsInDay] = big.NewInt(49_929_341)
	totalsByEpoch[183*builtin.EpochsInDay] = big.Add(totalsByEpoch[183*builtin.EpochsInDay], big.NewInt(32_787_700))

	// 1 year
	totalsByEpoch[365*builtin.EpochsInDay] = big.NewInt(22_421_712)

	// 2 years
	totalsByEpoch[2*365*builtin.EpochsInDay] = big.NewInt(7_223_364)

	// 3 years
	totalsByEpoch[3*365*builtin.EpochsInDay] = big.NewInt(87_637_883)

	// 6 years
	totalsByEpoch[6*365*builtin.EpochsInDay] = big.NewInt(100_000_000)
	totalsByEpoch[6*365*builtin.EpochsInDay] = big.Add(totalsByEpoch[6*365*builtin.EpochsInDay], big.NewInt(300_000_000))
